...
public class TwoModeFragment extends Fragment {

    private FragmentTwomodeBinding binding;
    //String urlport ="http://192.168.0.33:3333/";
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        TwoModeViewModel slideshowViewModel =
                new ViewModelProvider(this).get(TwoModeViewModel.class);

        binding = FragmentTwomodeBinding.inflate(inflater, container, false);
...
//        slideshowViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        //        //开灯逻辑
        Button button = (Button) view.findViewById(R.id.submitFlow);
    ...
    public void flowHttpRequest(View view) {
        ...
        String urlString = "http://"+ GlobalHttpUrl.url +":3333/ledtype?typenum=1"; // 替换为你的URL
        new Thread(() -> {
            try {
