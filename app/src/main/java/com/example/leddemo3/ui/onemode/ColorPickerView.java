...
public class ColorPickerView extends View {private static final float PI = (float) Math.PI;
    ...
    public ColorPickerView(Context context) {
        ...
        double Zoom = (double) (density / 2.0 + 1.3);
    ...
    private void init(int color, double Zoom) {
        ...
        paintGray.setStrokeWidth((float) (60 * Zoom));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(CenterX * 2 + 100, CenterY * 2 + 23);
    }
